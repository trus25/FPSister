...
#    Dec 10, 2019 03:31:45 PM +07  platform: Windows NT
...
class MainGame:
    def __init__(self, top=None):
        ...
        self.LblTurn = tk.Label(top)
        self.LblTurn.place(relx=0.213, rely=0.041, height=40, width=450)
        self.LblTurn.configure(activebackground="#f9f9f9")
        self.LblTurn.configure(activeforeground="black")
        self.LblTurn.configure(background="#000000")
        self.LblTurn.configure(disabledforeground="#a3a3a3")
        self.LblTurn.configure(font="-family {UD Digi Kyokasho NP-R} -size 14")
        self.LblTurn.configure(foreground="#ffffff")
        self.LblTurn.configure(highlightbackground="#d9d9d9")
        self.LblTurn.configure(highlightcolor="black")
        self.LblTurn.configure(text='''Nama Turn''')
